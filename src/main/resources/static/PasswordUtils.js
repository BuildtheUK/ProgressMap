...
export function initiatePasswordBoxButtons() {
    ...
    //select by class in future

    const previousPassword = document.getElementById("oldPasswordInput")
    const showPreviousPassword = document.getElementById("showOldPassword")
    ...
    if (showPreviousPassword != null) {
        showPreviousPassword.addEventListener("click", () => {
            if (previousPassword.type === "password") {
                previousPassword.type = "text";
                showPreviousPassword.innerHTML = eyeOffSVG
            } else {
                previousPassword.type = "password";
                showPreviousPassword.innerHTML = eyeOnSVG
            }
        })
    }
